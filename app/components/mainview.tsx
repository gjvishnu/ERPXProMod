   ...
   {/* menus END */}
                  ...
                  {/* first div END*/}
                    ...
                    <div className="w-1/2 ">
                     ...
                     {/* third div */}
                    <div className="w-1/3">
                      <h6 className="ps-3 text-primary text-xs">Stories</h6>
                      {/* stories */}
                      <div className="stoireMain h-1/6  px-2 py-1 flex space-x-1  overflow-x-hidden  overflow-x-scroll">
                      {
                        arr.map((e,i)=>(
         <a key={i}><div className="h-full w-14  rounded-xl">
          <video autoPlay muted loop className='vidB rounded-xl'>
<source src={story} type="video/mp4"/>
                      ...
                      {/* stories END */}
                      <h6 className="ps-3 text-primary text-xs">Suggestions</h6>
                      <div className="h-3/6  p-2 overflow-y-hidden space-y-2 overflow-y-scroll stoireMain">
                         {/* follow user  */}
                         {arr.map((e)=>(
      ...
      <button className='bg-primary w-20 text-white rounded-lg h-5 text-xs'>Follow</button>
          ...
          <span> <div className="bg-black h-full w-40 bgrecom"></div></span>
          <span> <div className="bg-black h-full w-40 bgrecom"></div></span>
          <span> <div className="bg-black h-full w-40 bgrecom"></div></span>
          <span> <div className="bg-black h-full w-40 bgrecom"></div></span>
                      </div>
